...
def get_encounter_number(start_date):
    ...
    encounters = {
        ...
        'E18': ('2023-12-20', '2024-01-05'),
        'E19': ('2024-03-22', '2024-04-05'),
        'E20': ('2024-06-25', '2024-07-10'),
        'E21': ('2024-09-20', '2024-10-05'),
        'E22': ('2024-12-20', '2025-01-05'),
        'E23': ('2025-03-15', '2025-04-01'),
        'E24': ('2025-06-15', '2025-07-01'),
        'E25': ('2025-09-15', '2025-10-01'),
        'E26': ('2025-12-15', '2026-01-01'),
        'E27': ('2026-03-15', '2026-04-01'),
        'E28': ('2026-06-15', '2026-07-01'),
    }
